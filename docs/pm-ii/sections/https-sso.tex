...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{apple_sso_2}
    \caption{Apple SSO 1}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{apple_sso_1}
    \caption{Apple SSO 2}
...
\vspace{1em}
% \lstinputlisting[language=JavaScript, firstline=65, lastline=68, label={lst:addCollectionEntry}]{../../../src/app.js}
\vspace{1em}
