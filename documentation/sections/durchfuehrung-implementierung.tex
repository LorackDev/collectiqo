...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{youtrack_screenshot_agile_board}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{landing-page}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{login-sign-up-pages}
    \caption{Login/Sign-Up}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{collection-home-page}
