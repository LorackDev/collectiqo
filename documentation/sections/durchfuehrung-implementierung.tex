...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.86\textwidth]{landing-page}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.86\textwidth]{login-sign-up-pages}
    \caption{Login/Sign-Up}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.86\textwidth]{collection-home-page}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.86\textwidth]{collection-add-modal}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.86\textwidth]{collection-home-page2}
...
Einzelne Einträge innerhalb der Collections werden wie in Abbildung 19 strukturiert.
...
\vspace{1em}
\lstinputlisting[language=JavaScript, label={lst:insertTemplates}]{../scripts/mongodb/setDefaultTemplates.js}
\vspace{1em}
